  ...
  return (
    <div className="detail-layout">
      ...
      <div className="detail-content">
        <h2 className="detail-heading"> <span>مسجد میں داخل ہوتے اور نکلتے وقت صلوٰۃ و سلام</span> </h2>
        <p className="detail-text-refined-text">
          <span className="duaa"> عن فاطمة رضى الله عنها بنت <strong>رسول الله صلى الله عليه وآله وسلم</strong> قالت: كان <strong>رسول الله</strong> إذا دخل المسجد يقول: </span>
          <span className="duaa"> : "بِسْمِ اللهِ وَالسَّلَامُ عَلَى رَسُولِ اللهِ، اللّهُمَّ اغْفِرْ لِى ذُنُوبِى وَافْتَحْ لِى أَبْوَابَ رَحْمَتِكَ" </span>
          <span className="duaa"> و إذا خرج قال : "بِسْمِ اللهِ وَالسَّلَامُ عَلَى رَسُولِ اللَّهِ، اللَّهُمَّ اغْفِرْ لِى ذُنُوبِي وَافْتَحْ لِى ابْوَابَ فَضْلِكَ". </span>
          <br />
          ...
          <br />
          <span className="duaa"> " بِسْمِ اللهِ وَالسَّلَامُ عَلَى رَسُولِ اللَّهِ اللَّهُمَّ اغْفِرْ لِى ذُنُوبِي وَافْتَحْ لِى أَبْوَابَ رَحْمَتِكَ". </span>
          <br />
          ...
          <br />
          <span className="duaa"> "بِسْمِ اللَّهِ وَالسَّلَامُ عَلَى رَسُولِ اللَّهِ اللَّهُمَّ اغْفِرْ لِى ذُنُوبِى وَافْتَحْ لِى أَبْوَابَ فَضْلِكَ". </span>
          <br />
          ...
          <br />
          <span className="duaa"> "بِسْمِ اللهِ وَالسَّلَامُ عَلَى رَسُولِ اللهِ اللَّهُمَّ اغْفِرْ لِى ذُنُوبِى وَافْتَحْ لِى أَبْوَابَ رَحْمَتِكَ". </span>
          <br />
          جب آپؐ مسجد سے باہر تشریف لاتے تو فرماتے:
          <br />
          <span className="duaa"> "بِسْمِ اللهِ وَالسَّلَامُ عَلَى رَسُولِ اللهِ اللَّهُمَّ اغْفِرْ لِى ذُنُوبِى وَافْتَحْ لِى أَبْوَابَ فَضْلِكَ". </span>
        </p>
