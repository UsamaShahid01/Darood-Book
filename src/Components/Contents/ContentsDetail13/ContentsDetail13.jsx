  ...
  return (
    <div className="detail-layout">
      ...
      <div className="detail-content">
        <h2 className="detail-heading"> <span>ذکر الٰہی اور درود شریف سے خالی بدقسمت مجلس کا ذکر</span> </h2>
        <p className="detail-text-refined-text">
          <span className="duaa"> عن جابر رضی الله عنه قال: قال رسول الله <strong>ﷺ</strong>: "ما اجتمع قوم ثم تفرقوا عن غير ذكر الله وصلاة على النبی إلا قاموا عن أنتن من جيفة". </span>
          <br />
          <span className="duaa"> [صحيح الجامع الصغير وزيادته للألبانی، المجلد الثانی، رقم الحديث: ٥٥٠٦ --- بحواله الطيالسی وشعب الإيمان للبيهقی ] </span>
          <br />
          ...
          <br />
          <span className="duaa"> عن أبی هريرة عن النبی <strong>ﷺ</strong> قال: ما جلس قوم مجلساً لم يذكروا الله فيه ولم يصلوا على نبيهم إلا كان عليهم ترة، فإن شاء عذبهم وإن شاء غفر لهم. </span>
          <br />
          <span className="duaa"> [سنن الترمذی، أبواب الدعوات، باب ما جاء فی القوم يجلسون ولا يذكرون الله] </span>
          <br />
          ...
          چاہے تو معاف کر دے۔
          <br />
          <span className="duaa"> عن أبی هريرة رضی الله عنه قال: قال رسول الله <strong>ﷺ</strong>: ما قعد قوم لم يذكروا فيه الله عزّ و جلّ ويصلوا على النبی صلى الله عليه وسلم الا كان عليهم حسرة يوم القيامة وإن دخلوا الجنة للثواب. </span>
          <br />
          <span className="duaa"> [سلسلة الأحاديث الصحيحة للألبانی، المجلد الأول، رقم الحديث: ٧٦ --- بحواله مسند أحمد، ( ٤٦٣/٢ ) ابن حبان فی  صحيحه (۲۳۲۲۔۔موارد) و الحاكم (٤٩٢/١) ] </span>
          <br />
