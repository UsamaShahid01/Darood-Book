  ...
  return (
    <div className="detail-layout">
      ...
      <div className="detail-content">
        <h2 className="detail-heading"> <span>درودِ ابراہیمیؑ</span> </h2>
        <p className="detail-text-refined-text">
          <p> <span className="duaa"> عن عبد الرحمن بن أبی ليلى قال: لقينی كعب بن عجرة فقال: ألا أُهدی لك هدية سمعتها من النبی <strong> ﷺ</strong> فقلت له: بلى فاهدها لی. فقال: سألنا رسول الله <strong> ﷺ</strong> فقلنا: يا رسول الله كيف الصلاة عليكم أهل البيت فإن الله قد علمنا كيف نسلم. قال: قولوا: اللَّهُمَّ صَلِّ عَلَى مُحَمَّدٍ وَ عَلَى آلِ مُحَمَّدٍ كَمَا صَلَّيْتَ عَلَى إِبْرَاهِيمَ وَعَلَى آلِ إِبْرَاهِيمَ إِنَّكَ حَمِيدٌ مَجِيدٌ، اللَّهُمَّ بَارِكْ عَلَى مُحَمَّدٍ وَ عَلَى آلِ مُحَمَّدٍ كَمَا بَارَكْتَ عَلَى إِبْرَاهِيمَ وَعَلَى آلِ إِبْرَاهِيمَ إِنَّكَ حَمِيدٌ مَجِيدٌ. </span> </p>
          <p> <span className="duaa"> [صحيح البخاری، كتاب أحاديث الأنبياء، حدیث نمبر ۳۳۷۰] </span> </p>
          ...
          <p> <span className="duaa"> "اللَّهُمَّ صَلِّ عَلَى مُحَمَّدٍ وَ عَلَى آلِ مُحَمَّدٍ كَمَا صَلَّيْتَ عَلَى إِبْرَاهِيمَ وَعَلَى آلِ إِبْرَاهِيمَ إِنَّكَ حَمِيدٌ مَجِيدٌ، اللَّهُمَّ بَارِكْ عَلَى مُحَمَّدٍ وَ عَلَى آلِ مُحَمَّدٍ كَمَا بَارَكْتَ عَلَى إِبْرَاهِيمَ وَعَلَى آلِ إِبْرَاهِيمَ إِنَّكَ حَمِيدٌ مَجِيدٌ " .           </span> </p>
