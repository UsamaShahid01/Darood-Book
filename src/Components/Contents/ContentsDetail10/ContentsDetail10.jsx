    ...
    <div className="detail-layout">
      ...
      <div className="detail-content">
        ...
        <p className="detail-text-refined-text">
          ...
          <br />
          <span className="duaa"> عن انس رضى الله عنه قال قال رسول الله <strong>صلى الله عليه وسلم</strong> أكثروا الصلاة على يوم الجمعة و ليلة الجمعة فمن صلى على صلاة صلى الله عليه عشرا. </span>
          <br />
          <span className="duaa"> [صحيح الجامع الصغير وزيادته للألبانی المجلد الأول، رقم الحديث: ١٢٠٩ --- بحواله سنن البيهقى] </span>
          <br />
